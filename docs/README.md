...
| Run-ledger bootstrap, idempotency intent, lifecycle transition, terminal seal, and fixed-point conformance | [`dolgorae-idempotency-intent-v1.schema.json`](protocol/dolgorae-idempotency-intent-v1.schema.json), [`dolgorae-audit-record-v1.schema.json`](protocol/dolgorae-audit-record-v1.schema.json), [`dolgorae-ledger-conformance-v1.json`](protocol/dolgorae-ledger-conformance-v1.json), and [`validate_task003c_conformance.py`](../tools/validators/validate_task003c_conformance.py) | SPEC-006, SPEC-008, SPEC-010, Manifest and Ledger Model, TASK-003-C |
